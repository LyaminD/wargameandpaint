...
<body>
    <div id="loginBackground" class=" text-center mb-5 mt-5">
        <h1>Bienvenue sur Wargame & Paint ! ! !</h1>
        ...
        <div class="container">
            <div class="tribunal text-center my-5">
                <img src="{{ asset('images/logo.png') }}" class="banner">
            </div>
        </div>
                        ...
                        <div class="modal fade text-dark" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <p id="text" style="display:none"><a href="{{ route('register') }}" class="btn btn-primary" role="button" data-bs-toggle="button">S'enregistrer</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
